  ...
  try {
    ...
    if (useSupabase || !pgClient) {
      ...
      const result = await pgClient.query(
        `SELECT id, agency_id, document_type, document_name, file_name, file_path, file_url,
...
// Document URL/view routes removed - frontend should use file_path from API responses
